    ...
    public class DbSeeder
    {
        public static async Task SeedAsync(KicsitLibraryDbContext context, IPasswordHasher passwordHasher)
        {
            ...
            var defaultSettings = new Dictionary<string, (string Value, string Description, string Group)>
            {
                ...
                { "WhatsAppNotificationEnabled", ("False", "Enable or disable WhatsApp alerts via Twilio", "Notifications") },
                { "SmsNotificationEnabled", ("False", "Enable or disable SMS alerts via Twilio", "Notifications") },
                { "SmsTwilioAccountSid", ("", "Twilio Account SID for SMS/WhatsApp", "Notifications") },
                { "SmsTwilioAuthToken", ("", "Twilio Auth Token for SMS/WhatsApp", "Notifications") },
                { "SmsTwilioFromNumber", ("", "Twilio phone number for SMS", "Notifications") },
                { "WhatsAppTwilioFromNumber", ("", "Twilio phone number for WhatsApp", "Notifications") },
