    ...
    public class DbSeeder
    {
        public static async Task SeedAsync(KicsitLibraryDbContext context, IPasswordHasher passwordHasher)
        {
            ...
            var defaultSettings = new Dictionary<string, (string Value, string Description, string Group)>
            {
                ...
                { "EmailNotificationEnabled", ("True", "Enable or disable email alerts", "Notifications") },
                { "WhatsAppPlaceholderEnabled", ("False", "Placeholder flag for future WhatsApp gateway integration", "Notifications") },
                ...
                { "DatabaseProvider", ("SqlServer", "Database provider: SqlServer or Sqlite", "Database") },
